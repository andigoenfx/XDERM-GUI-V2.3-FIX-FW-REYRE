...
<style>
		...
		.geser {
			...
			color: #ffffff;
			padding: 3px 20px;
			background-image: linear-gradient(45deg, #00dcf3 50%, transparent 50%);
		...
		.box_script {
			...
			box-shadow: 0px 0px 5px 2px #59c9aa;
		}
...
echo '<input type="submit" name="simpan" class="btn slide" value="Simpan"/></form></div>';
} else {
